                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="create.php" class="btn btn-info"><i class="bi bi-plus-square"></i> Crear nueva institución</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="edit.php?id=<?=$id_config_institucion;?>" type="button" class="btn btn-info2 btn-sm"><i class="bi bi-pencil"></i></a>
