...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Listado de programas acad&eacutemicos</h1>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Programas acad&eacutemicos registrados</h3>
                            <div class="card-tools">
                                <a href="create.php" class="btn btn-info"><i class="bi bi-plus-square"></i> Crear nuevo programa acad&eacutemico</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                foreach ($niveles as $nivele){
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$nivele['programa'];?></td>
                                        <td><?=$nivele['modalidad'];?></td>
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="edit.php?id=<?=$id_nivel;?>" type="button" class="btn btn-info2 btn-sm"><i class="bi bi-pencil"></i></a>
